...
echo "        map = L.map(\'map\').setView([53.53971171573007, 8.582483639967288], 16);"

# google street layer
echo "        googleStreet = L.tileLayer(\'https://{s}.google.com/vt/lyrs=m&x={x}&y={y}&z={z}\', {"
echo '          maxZoom: 20,'
echo "          subdomains: [\'mt0\', \'mt1\', \'mt2\', \'mt3\']  });"

echo '      var marker = L.marker(54,56)'
echo '                   .addTo(map);'
